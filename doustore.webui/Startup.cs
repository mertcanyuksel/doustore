...
using doustore.business.Concrete;
using doustore.data.Abstract;
using doustore.data.Concrete.EfCore;
using doustore.webui.EmailServices;
using doustore.webui.Identity;

namespace doustore.webui
{
